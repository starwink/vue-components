            ...
            <Form ref="form" :label-width="86" @submit.native.prevent @keydown.native.enter.prevent="search">
                <Row>
                   ...
                   <Col span="6">
                    ...
                    <Col span="6">
                    <FormItem label="坐标">
                        <Input v-model="latlngCurrent"  placeholder="" @on-focus="doCopy"></Input>
                    </FormItem>
                    </Col>
                    <Col span="6">
                    <Button type="primary" @click.stop="setMapPoint">经纬度反查</Button>
...
export default {
    props: {
        mapcenter: {
            type: String,
            default: '34.84029502402593,113.7575912475586'
        },
        oldmarker: {
            type: String,
